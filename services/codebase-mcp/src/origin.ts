 ...
 *
 * With an empty allowlist (secrets-mcp default) any present Origin is rejected and
 * only no-Origin loopback traffic passes — exactly the loopback-only posture.
 */
